...
const double ZETA = 0.25; // Gravitational gain constant
const double EETA = 0.25; // Repulsive force gain
const double Q_STAR = 1; // Threshold of the barrier's acting distance
...
int main() {
    ...
    Point q = {0, 0};
    Point q_goal = {10, 10};
    std::vector<Point> obstacles = {{6, 6}, {6, 7}, {4, 4},{3, 4}, {8, 6}};
